...
import {
  ...
  ConfigOverrides,
  ConfigOverride
} from 'simple-swf/build/src/SWFConfig';
...
import {
  ...
  S3ClaimCheck,
  ClaimCheck
} from 'simple-swf/build/src/util';
...
import {
  MetricReporter,
  StatsDMetricReporter,
  StatsDMetricReporterConfig
} from './lib/MetricReporter';
...
export class Config {
  ...
  buildWorkflowRegistry(workflowLocations: string[]): WorkflowRegistry {
    return new WorkflowRegistry(workflowLocations, this);
  }
